...
void shader_program::SetUInt(const std::string &name, int value) const
{
...
void shader_program::SetVec4(const std::string &name, float x, float y, float z, float w)
{
...
bool shader_program::CheckCompileErrors(unsigned int shader)
{
    int success;
    char infoLog[1024];
