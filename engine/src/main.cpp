...
int main(void)
{
    ...
    s->emplace<Renderable>(e2, "../assets/objects/backpack/backpack.obj");
    ...
    s->emplace<AABB>(e2, ResourceManager::getInstance().getModel("../assets/objects/backpack/backpack.obj"));
    ...
    f1.b_ignorePitchRotation = false;
