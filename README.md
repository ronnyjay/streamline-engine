...
Use your distribution's package manager to install the necessary dependencies. The examples listed below use [pacman](https://wiki.archlinux.org/title/Pacman) (Arch Linux):
